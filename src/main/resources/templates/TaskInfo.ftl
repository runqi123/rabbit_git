...
<div class="total">
    ...
    <p class="juB">JU币 : ${taskUp.price}个</p>
...
<div class="neirong" align="center">
    <div class="set" align="left">
        ...
        <br/>
        <span class="blueRediu"></span><a>${taskUp.taskCreateTime?string("MM月dd日 HH:mm")}</a>
        <hr />
        <p class="renwuNR">
...
<div class="footer">
    <a class="aioc aioc1" href="../to/upTask?taskId=${taskUp.taskId}">接受此任务</a>
    <a class="aioc aioc2" href="../to/MyHome">返回</a>
</div>
</body>
</html>
